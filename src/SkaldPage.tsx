...
const SkaldPage = ({ onBack }: Props) => (
  <div className="min-h-screen bg-[#1a1611] text-[#d4953a] p-8 text-center">
    ...
    <div className="max-w-2xl mx-auto mt-24">
      <h1 className="text-4xl mb-8 drop-shadow-lg">Skald Portfolio</h1>
      <p className="opacity-70">
        The scribes are sharpening quills. Stories will arrive soon.
      </p>
